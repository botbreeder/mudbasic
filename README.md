...
- Low detail level is only the minimum: where are things, is there anything terribly important happening, when does things begin and end, and that's about it.
...
- High-level of details includes not only what's happening but also _how_ it's happening, and sometimes why.
